...
@pytest.mark.vcr()
async def test_format_consultants_json_success():
    expected_result = {
        "type": "laborious",
        "gender": "f",
    ...
    format_consultants = ConsultantsJsonController(
        client=client,
...
@patch("src.api.controllers.json.JsonClient.request")
async def test_format_consultants_json_error(mock_client):
